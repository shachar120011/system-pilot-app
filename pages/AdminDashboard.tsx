...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({ activeView }) => {
  ...
  // ---------------------------------------------------------
  // כל ה-return-ים שונו כדי לתת גובה מסך מלא וגלילה פנימית!
  // ---------------------------------------------------------

  if (!isAuthenticated) {
      return (
          // תיקון: הגדרת h-screen ו-w-full
  ...
  if (activeView === 'knowledge') {
    return (
      // תיקון: הגדרת h-screen, w-full ו-overflow-y-auto
      <div className="h-screen w-full overflow-y-auto bg-slate-50 p-6 md:p-10 animate-fadeIn">
  ...
  return (
    // תיקון: הגדרת h-screen, w-full ו-overflow-y-auto בלוח הראשי
    <div className="h-screen w-full overflow-y-auto bg-slate-50 p-6 md:p-10 animate-fadeIn">
